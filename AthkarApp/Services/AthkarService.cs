        ...
        _categories = new List<AthkarCategory>
        {
            new AthkarCategory
            {
                ...
                AthkarList = new List<ThikrItem>
                {
                    ...
                    new() { Text = "اللَّهُمَّ بِكَ أَصْبَحْنَا، وَبِكَ أَمْسَيْنَا، وَبِكَ نَحْيَا وَبِكَ نَمُوتُ، وَإِلَيْكَ النُّشُورُ", Reference = "الترمذي 5/466", Count = 1 },
                    new() { Text = "اللَّهُمَّ أَنْتَ رَبِّي لاَ إِلَهَ إِلاَّ أَنْتَ، خَلَقْتَنِي وَأَنَا عَبْدُكَ، وَأَنَا عَلَى عَهْدِكَ وَوَعْدِكَ مَا اسْتَطَعْتُ، أَعُوذُ بكَ مِنْ شَرِّ مَا صَنَعْتُ، أَبُوءُ لَكَ بِنِعْمَتِكَ عَلَيَّ، وَأَبُوءُ لَكَ بِذَنْبِي فَاغْفِرْ لِي فَإِنَّهُ لاَ يَغْفِرُ الذُّنُوبَ إِلاَّ أَنْتَ", Reference = "البخاري 7/150", Count = 1 },
                    new() { Text = "يَا حَيُّ يَا قَيُّومُ بِرَحْمَتِكَ أَسْتَغِيثُ أَصْلِحْ لِي شَأْنِي كُلَّهُ وَلَا تَكِلْنِي إِلَى نَفْسِي طَرْفَةَ عَيْنٍ", Reference = "الحاكم 1/545", Count = 1 },
                    new() { Text = "أَسْتَغْفِرُ اللَّهَ وَأَتُوبُ إِلَيْهِ", Reference = "البخاري مع الفتح 11/101", Count = 100 }
                }
            },
            new AthkarCategory
            {
                ...
                AthkarList = new List<ThikrItem>
                {
                    ...
                    new() { Text = "اللَّهُمَّ بِكَ أَمْسَيْنَا، وَبِكَ أَصْبَحْنَا، وَبِكَ نَحْيَا وَبِكَ نَمُوتُ، وَإِليْكَ الْمَصِيرُ", Reference = "الترمذي 5/466", Count = 1 },
                    new() { Text = "بِسْمِ اللَّهِ الَّذِي لَا يَضُرُّ مَعَ اسْمِهِ شَيْءٌ فِي الْأَرْضِ وَلَا فِي السَّمَاءِ وَهُوَ السَّمِيعُ الْعَلِيمُ", Reference = "الترمذي 5/465", Count = 3 },
                    new() { Text = "أَعُوذُ بِكَلِمَاتِ اللَّهِ التَّامَّاتِ مِنْ شَرِّ مَا خَلَقَ", Reference = "أحمد 2/290", Count = 3 }
                }
            },
            new AthkarCategory
            {
                ...
                AthkarList = new List<ThikrItem>
                {
                    ...
                    new() { Text = "الْحَمْدُ لِلَّهِ الَّذِي عَافَانِي فِي جَسَدِي، وَرَدَّ عَلَيَّ رُوحِي، وَأَذِنَ لِي بِذِكْرِهِ", Reference = "الترمذي", Count = 1 }
                }
            },
            new AthkarCategory
            {
                ...
                AthkarList = new List<ThikrItem>
                {
                    ...
                    new() { Text = "بِسْمِ اللهِ، وَالصَّلَاةُ وَالسَّلَامُ عَلَى رَسُولِ اللهِ، اللَّهُمَّ اغْفِرْ لِي ذُنُوبِي، وَافْتَحْ لِي أَبْوَابَ رَحْمَتِكَ", Reference = "ابن ماجه", Count = 1 }
                }
            },
            new AthkarCategory
            {
                ...
                AthkarList = new List<ThikrItem>
                {
                    ...
                    new() { Text = "اللَّهُمَّ أَعِنِّي عَلَى ذِكْرِكَ، وَشُكْرِكَ، وَحُسْنِ عِبَادَتِكَ", Reference = "أبو داود", Count = 1 },
                    new() { Text = "سُبْحَانَ اللهِ (33)، الْحَمْدُ للهِ (33)، اللهُ أَكْبَرُ (33)", Reference = "مسلم", Count = 33 }
                }
            },
            new AthkarCategory
            {
                ...
                AthkarList = new List<ThikrItem>
                {
                    ...
                    new() { Text = "اللَّهُمَّ إِنَّا نَسْأَلُكَ فِي سَفَرِنَا هَذَا الْبِرَّ وَالتَّقْوَى، وَمِنَ الْعَمَلِ مَا تَرْضَى", Reference = "مسلم", Count = 1 }
                }
            },
            new AthkarCategory
            {
                ...
                AthkarList = new List<ThikrItem>
                {
                    ...
                    new() { Text = "لَا إِلَهَ إِلَّا اللهُ الْعَظِيمُ الْحَلِيمُ، لَا إِلَهَ إِلَّا اللهُ رَبُّ الْعَرْشِ الْعَظِيمِ", Reference = "البخاري", Count = 1 }
                }
            }
        };
    }
